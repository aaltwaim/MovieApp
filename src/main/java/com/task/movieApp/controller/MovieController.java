...
//	}
	...
	@RequestMapping("/movie/search")
	public Object searchMovie(@RequestParam("freeText") String freeText) {
		var movieUrl = searchUrl+api+"&query="+freeText;
		Object movies = restTemplate.getForObject(movieUrl, Object.class);
...
//	}
	@PostMapping("/movie/add")
	public Movie addMovie(Movie movie, @RequestParam int movieId) throws JsonMappingException, JsonProcessingException {
		System.out.println("heeeee");
		var favMovie = url+"/"+ movieId+api;
		HttpHeaders headers = new HttpHeaders();
		headers.setAccept(Arrays.asList(MediaType.APPLICATION_JSON));
		HttpEntity<String> entity = new HttpEntity<>("parameters", headers);
		System.out.println("result"+entity);
...
//	}
	@GetMapping("/movie/details")
	public Movie movieDetails(@RequestParam int id) {
		System.out.println("name "+ id);
...
//	}
	...
	@GetMapping("/movie/remove")
	public String removeFavMovie(@RequestParam int id) {
